...
// Add the request to the network
	...
	//this part stores the user that logged : his username and password
	Preferences.set("email", user.getEmail());
	Preferences.set("password", user.getPassword());
	String testEmail = Preferences.get("email", null);
	String testPassword = Preferences.get("password", null);
